...
def load_model_for_resume(args, model_without_ddp, *, strict: bool = True):
    ...
    # MDL tangent-core TRSO checkpoints cannot be resumed directly because
    # their calibrated bases are data-derived and are attached after model construction.
    # main.py rejects that unsupported path before optimizer restoration.
