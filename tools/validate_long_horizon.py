...
def run(seed:int):
    ...
    return {'seed':seed,'epochs':30,'fixed_accuracy':fa,'method_accuracy':ma,'gain':ma-fa,'fixed_adapter_parameters':fixed_params,'method_adapter_parameters':report.adapter_parameters,'selected_tensors':report.selected_tensors}
