# Kaggle one-cell revision experiment session 14. GPU + Internet ON.
import sys
...
url = 'https://raw.githubusercontent.com/tydeptrai21042004/TRSO_GCREST/main/kaggle/revision_session_runner.py'
urllib.request.urlretrieve(url, runner)
sys.path.insert(0, str(runner.parent))
from revision_session_runner import run_revision_session
run_revision_session(14)
